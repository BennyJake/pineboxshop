...
$validationArray = [];
if (isset($post) && !empty($post) && empty($post['address'])) {

    $recaptcha = new \ReCaptcha\ReCaptcha($config['PINEBOXSHOP_RECAP_SECRET_KEY']);
    $resp = $recaptcha->setExpectedHostname('localhost')
        ->setExpectedAction('contact')
        ->setScoreThreshold(0.5)
        ->verify($post['recaptcha_response'], $_SERVER['REMOTE_ADDR']);
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 order-lg-1">
                <div>
                    ...
                    <p>About me goes here. More copy.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="">
                    ...
                    <form method="post" action="#contact_me">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control special-input" name="name">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="contact" id="inlineRadio1"
                                       value="emailOption">
                                <label class="form-check-label" for="inlineRadio1">Email</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="contact" id="inlineRadio2"
                                       value="phoneOption">
...
<footer class="py-5">
    <div class="container">
        <p class="m-0 text-center text-white small">Copyright &copy; The Pine Box
            Shop <?= date('Y', strtotime('now')) ?></p>
    </div>
    <!-- /.container -->
</footer>
...
<div class="fb-customerchat"
     ...
     page_id="536961933127683"
     theme_color="#160700"
     logged_in_greeting="Hey, how can I help you?"
     logged_out_greeting="Hey, how can I help you?">
</div>
<!-- FB CHAT -->
<script src="https://www.google.com/recaptcha/api.js?render=<?= $config['PINEBOXSHOP_RECAP_SITE_KEY'] ?>"></script>
<script>
    grecaptcha.ready(function () {
        grecaptcha.execute("<?= $config['PINEBOXSHOP_RECAP_SITE_KEY'] ?>", {action: 'contact'}).then(function (token) {
